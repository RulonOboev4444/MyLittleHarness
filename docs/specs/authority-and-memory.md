...
- Archive/Evidence: archived plans, archived reference material, `project/verification/*.md`, agent-run records, work claims, handoff packets, approval packets, review-token inputs, and durable proof/evidence records. These are cold source-bound evidence recovered by pointer for audit, calibration, or closeout support; they are not default continuation state and cannot approve lifecycle movement by themselves.
