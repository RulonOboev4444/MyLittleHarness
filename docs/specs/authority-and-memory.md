...
Context remains tiered:

- Hot context is current continuation state and active-plan metadata.
- Warm context is roadmap, related specs, and current research distillates.
- Cold context is archived plans, raw research, historical state, and old evidence.
- Disposable maps are generated projections, SQLite indexes, or external retrieval output.
